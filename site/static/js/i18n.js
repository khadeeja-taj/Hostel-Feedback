...
const I18N = {
  en: {
    ...
    tick_anon: "Anonymous",
    tick_time: "~3 Minutes",
    tick_resp: "1,240+ Responses",
    tick_review: "Reviewed Monthly",
    next: "Next",
    back: "Back",
    ...
    sec_blocks: "Block Analytics (A–H)",
    ...
    th_date: "Date",
    th_actions: "Actions",
    sec_responses: "All Responses",
    act_view: "View",
    act_delete: "Delete",
    confirm_delete: "Delete this response? This cannot be undone.",
    resp_none: "No responses yet.",
    ...
    bd_respondents: "Students who rated",
  ...
  ar: {
    ...
    tick_anon: "مجهول الهوية",
    tick_time: "٣ دقائق",
    tick_resp: "أكثر من ١٢٤٠ رد",
    tick_review: "مراجعة شهرية",
    next: "التالي",
    back: "السابق",
    ...
    sec_blocks: "تحليلات المباني (A–H)",
    ...
    th_date: "التاريخ",
    th_actions: "إجراءات",
    sec_responses: "كل الردود",
    act_view: "عرض",
    act_delete: "حذف",
    confirm_delete: "حذف هذا الرد؟ لا يمكن التراجع.",
    resp_none: "لا توجد ردود بعد.",
    ...
    bd_respondents: "الطلاب الذين قيّموا",
